...
class TestLoginUser:
    ...
    def test_login_user_success(self, new_user_and_login_data):
        payload = new_user_and_login_data
    ...
    def test_login_user_with_wrong_fields_failure(self, wrong_field, new_user_and_login_data):
        payload = user_helpers.generate_user_login_data_with_wrong_field(wrong_field, new_user_and_login_data)
